...
| [reports/esm2-position-ablation-2026-06-14.md](reports/esm2-position-ablation-2026-06-14.md) | `position_col` per-residue feature와 CLS fallback 비교, cache reuse 개선 검증 |
